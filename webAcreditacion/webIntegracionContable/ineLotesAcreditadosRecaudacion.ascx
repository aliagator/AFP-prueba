...
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ineLotesAcreditadosRecaudacion.ascx.vb" Inherits="Sonda.Gestion.Adm.WEB.IngresoEgreso.Acreditacion.ineLotesAcreditadosRecaudacion" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
                    ...
                    <table class="TablaTitulo" id="Table7" cellspacing="1" cellpadding="1" width="100%" align="left" border="0">
                        <tr>
                            <td class="ttFilaTitulo">
                                <p align="center">
                                    <cc1:Label ID="Label2" Height="57px" runat="server" Width="640px" Tipo="Titulo">Informe de Validación Lotes Acreditados Recaudación Fecha Contable</cc1:Label>
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <table class="TablaGrupoDato" id="Table8" style="height: 80px" cellspacing="1" cellpadding="1" width="100%" border="0" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="tfFilaDato" style="width: 48px; height: 26px">
                            <p align="left">
                                <cc1:FechaAdv ID="fechaLotes" runat="server" Tipo="NombreCampo" AutoPostBack="True" Despliegue="DDMMAAAA" Requerido="True" GuardarEnHistoria="True"></cc1:FechaAdv>
                            </p>
                        </td>
                        <td class="tfFilaDato" style="width: 48px; height: 26px">
                            <p align="left">
