...
Public Class rptDetallePlanillaTesoreria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDetallePlanillaTesoreria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sonda.Gestion.Adm.Rpt.Acreditacion.rptDetallePlanillaTesoreria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VID_ADM() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VFECHA_DIARIA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptDetallePlanillaTesoreria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDetallePlanillaTesoreria = New rptDetallePlanillaTesoreria()
        rpt.Site = Me.Site
        Return rpt
    End Function
